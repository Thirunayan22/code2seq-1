...
# TODO - 5 - Build a function that can take in a string of source code as input and can output a ast-context path that can be directly fed into the model
...
# TODO - 8 - Create this java extraction function as an
